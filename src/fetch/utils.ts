...
interface HeaderParser {
  canParse: (options: RequestConfig) => boolean
  parse: (headers: Headers) => Headers
}

export const parseHeaders = (options: RequestConfig) => {
...
export const parseBody = (options: RequestConfig, isAppJson: boolean) => {
  if (!options) {
    return options
  }
...
export const parseCredentials = (options: RequestConfig): RequestCredentials => {
  if (!options) {
    return options
  }
...
export const parseInitFromOptions = (options: RequestConfig): RequestInit => {
...
export const parseUrlFromOptions = (options: RequestConfig): string => {
